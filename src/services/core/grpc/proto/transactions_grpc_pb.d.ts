...
interface ITransactionsStreamService
  extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  subscribeTransactions: ITransactionsStreamService_ISubscribeTransactions;
}

interface ITransactionsStreamService_ISubscribeTransactions
  extends grpc.MethodDefinition<
    transactions_pb.SubscribeTransactionsRequest,
    transactions_pb.TransactionEvent
  > {
...
export interface ITransactionsStreamServer
...
export interface ITransactionsStreamClient {
  subscribeTransactions(
    request: transactions_pb.SubscribeTransactionsRequest,
    options?: Partial<grpc.CallOptions>,
  ): grpc.ClientReadableStream<transactions_pb.TransactionEvent>;
  subscribeTransactions(
    request: transactions_pb.SubscribeTransactionsRequest,
...
export class TransactionsStreamClient
  extends grpc.Client
  implements ITransactionsStreamClient
{
  constructor(
    address: string,
